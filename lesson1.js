const lesson1Data = {
    ...
    listeningQuiz: [
        { text: "Living a long and healthy life is everyone's desire.", transcript: "Living a long and healthy life is everyone's desire.", options: ["Sống một cuộc sống lâu và khỏe mạnh là mong ước của mọi người.", "Mọi người đều muốn ăn uống thoải mái.", "Cuộc sống ngắn ngủi và đầy rẫy thử thách."], answer: 0, exp: "Đúng nghĩa: Living a long and healthy life is everyone's desire." },
        { text: "Good genetics plays an important role in longevity.", transcript: "Good genetics plays an important role in longevity.", options: ["Gen tốt đóng vai trò quan trọng trong việc sống trường thọ.", "Thể dục thể thao giúp bạn trẻ lâu hơn.", "Thức ăn nhanh làm giảm tuổi thọ."], answer: 0, exp: "Đúng nghĩa: Good genetics plays an important role in longevity." },
        { text: "We should maintain a balanced diet every day.", transcript: "We should maintain a balanced diet every day.", options: ["Chúng ta nên tập thể dục mỗi ngày.", "Chúng ta nên duy trì chế độ ăn cân bằng mỗi ngày.", "Chúng ta nên đi ngủ sớm hơn."], answer: 1, exp: "Đúng nghĩa: We should maintain a balanced diet every day." },
        { text: "Fresh fruits and vegetables are very good for health.", transcript: "Fresh fruits and vegetables are very good for health.", options: ["Thịt bò và gà rất tốt cho tim mạch.", "Trái cây tươi và rau củ rất tốt cho sức khỏe.", "Nước ngọt có ga giúp cơ thể khỏe mạnh."], answer: 1, exp: "Đúng nghĩa: Fresh fruits and vegetables are very good for health." },
        { text: "People should limit fast food and sugary drinks.", transcript: "People should limit fast food and sugary drinks.", options: ["Mọi người nên ăn nhiều thức ăn nhanh.", "Mọi người nên hạn chế thức ăn nhanh và đồ uống có đường.", "Mọi người không nên uống nước lọc."], answer: 1, exp: "Đúng nghĩa: People should limit fast food and sugary drinks." },
        { text: "Regular physical activity keeps our hearts healthy.", transcript: "Regular physical activity keeps our hearts healthy.", options: ["Hoạt động thể chất đều đặn giúp tim mạch khỏe mạnh.", "Ngủ đủ giấc giúp tăng trưởng chiều cao.", "Ăn uống điều độ giúp da dẻ mịn màng."], answer: 0, exp: "Đúng nghĩa: Regular physical activity keeps our hearts healthy." },
        { text: "Working out at the gym is a great way to stay fit.", transcript: "Working out at the gym is a great way to stay fit.", options: ["Tập gym là một cách tuyệt vời để giữ dáng.", "Đi ngủ muộn giúp tinh thần sảng khoái.", "Xem tivi giúp rèn luyện trí nhớ."], answer: 0, exp: "Đúng nghĩa: Working out at the gym is a great way to stay fit." },
        { text: "Getting enough sleep helps reduce stress effectively.", transcript: "Getting enough sleep helps reduce stress effectively.", options: ["Ăn uống nhiều giúp giảm căng thẳng.", "Ngủ đủ giấc giúp giảm stress hiệu quả.", "Làm việc quá sức giúp sống lâu hơn."], answer: 1, exp: "Đúng nghĩa: Getting enough sleep helps reduce stress effectively." },
        { text: "Avoiding smoking protects your lungs and body.", transcript: "Avoiding smoking protects your lungs and body.", options: ["Tránh hút thuốc bảo vệ lá phổi và cơ thể bạn.", "Uống rượu bia giúp tăng cường trí nhớ.", "Thức khuya giúp làm việc hiệu quả hơn."], answer: 0, exp: "Đúng nghĩa: Avoiding smoking protects your lungs and body." },
        { text: "These positive habits improve our quality of life.", transcript: "These positive habits improve our quality of life.", options: ["Những thói quen tích cực này cải thiện chất lượng cuộc sống của chúng ta.", "Những thói quen xấu làm chúng ta thông minh hơn.", "Lười vận động giúp cơ thể tràn đầy năng lượng."], answer: 0, exp: "Đúng nghĩa: These positive habits improve our quality of life." }
    ],
