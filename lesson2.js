const lesson2Data = {
    ...
    listeningQuiz: [
        { text: "Do you exercise every day? Yes, I do.", options: ["Bạn có tập thể dục mỗi ngày không? Có, tôi có.", "Bạn có ăn rau không? Không, tôi không.", "Bạn có đi ngủ sớm không? Có, tôi có."], answer: 0, exp: "Đúng nghĩa: Do you exercise every day? Yes, I do." },
        { text: "Does she eat a balanced diet? Yes, she does.", options: ["Cô ấy có ăn chế độ cân bằng không? Có, cô ấy có.", "Anh ấy có tập gym không? Có, anh ấy có.", "Họ có uống nhiều nước không? Có, họ có."], answer: 0, exp: "Đúng nghĩa: Does she eat a balanced diet? Yes, she does." },
        { text: "Can I drink cold water after working out?", options: ["Tôi có thể uống nước lạnh sau khi tập luyện không?", "Tôi có thể đi bơi vào buổi sáng không?", "Tôi có thể ăn đồ ngọt vào buổi tối không?"], answer: 0, exp: "Đúng nghĩa: Can I drink cold water after working out?" },
        { text: "Could we improve our muscle strength?", options: ["Chúng ta có thể cải thiện sức mạnh cơ bắp không?", "Chúng ta có thể giảm cân nhanh chóng không?", "Chúng ta có thể ngủ nhiều hơn không?"], answer: 0, exp: "Đúng nghĩa: Could we improve our muscle strength?" },
        { text: "Were they suffering from severe stress?", options: ["Họ có bị căng thẳng nặng không?", "Họ có đang tập thể dục không?", "Họ có đi khám bác sĩ không?"], answer: 0, exp: "Đúng nghĩa: Were they suffering from severe stress?" },
        { text: "Has he started the medical treatment yet?", options: ["Anh ấy đã bắt đầu điều trị y tế chưa?", "Cô ấy đã khỏi bệnh chưa?", "Bác sĩ đã khám xong chưa?"], answer: 0, exp: "Đúng nghĩa: Has he started the medical treatment yet?" },
        { text: "Have you started working out again?", options: ["Bạn đã bắt đầu tập luyện trở lại chưa?", "Bạn đã nghỉ học từ bao giờ thế?", "Bạn đã ăn tối chưa?"], answer: 0, exp: "Đúng nghĩa: Have you started working out again?" },
        { text: "Was it your grandfather who taught you?", options: ["Có phải ông của bạn là người đã dạy bạn không?", "Có phải bác sĩ là người đã khám cho bạn không?", "Có phải bố bạn là người đã nấu ăn không?"], answer: 0, exp: "Đúng nghĩa: Was it your grandfather who taught you?" },
        { text: "Yes, I have.", options: ["Vâng, đúng vậy (Hiện tại hoàn thành).", "Không, tôi chưa từng.", "Vâng, tôi đã làm hôm qua."], answer: 0, exp: "Đúng nghĩa: Yes, I have." },
        { text: "Yes, it was.", options: ["Vâng, đúng vậy (Quá khứ đơn).", "Không, không phải.", "Vâng, tôi có thể."], answer: 0, exp: "Đúng nghĩa: Yes, it was." }
    ],
...
```*(Assuming you are working on a coding project where `lesson1` and `lesson2` are failing to link properly with your `index` file or are throwing data-not-found errors...)*

To fix the "data not found" error and ensure seamless integration, we need to make sure that the paths, data structures, or module imports in **`lesson1`** and **`lesson2`** match what your **`index`** file expects. 

Since I don't see your exact code, here is a standard, robust template and checklist to align them.

---

### Step 1: Check Your `index` File Setup
Make sure your main `index` file is correctly importing or routing to `lesson1` and `lesson2`. 

**Example (Node.js / Express or ES6 Modules):**
```javascript
// index.js
import express from 'express';
import lesson1Router from './lesson1.js';
import lesson2Router from './lesson2.js';

const app = express();

app.use(express.json());

// Ensure the routes match what the frontend or router expects
app.use('/api/lesson1', lesson1Router);
app.use('/api/lesson2', lesson2Router);

app.listen(3000, () => {
    console.Hog('Server running on port 3000');
});