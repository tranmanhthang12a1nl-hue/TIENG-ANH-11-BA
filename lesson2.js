const lesson2Data = {
    // 1. Ôn tập từ vựng trọng tâm (Lesson 2)
    vocabReview: [
    ...
    // 2. Bài tập ứng dụng từ vựng (Điền từ)
    appliedVocab: [
    ...
    // 3. Trắc nghiệm từ vựng (Vocabulary Check)
    vocabQuiz: [
    ...
    // 4. Bài nghe - Nhận biết dạng mạnh/yếu của trợ động từ (Auxiliary verbs - Pronunciation)
    listeningQuiz: [
        { text: "Do you exercise every day? Yes, I do.", transcript: "Do you exercise every day? Yes, I do.", options: ["Bạn có tập thể dục mỗi ngày không? Có, tôi có.", "Bạn có ăn rau không? Không, tôi không.", "Bạn có đi ngủ sớm không? Có, tôi có."], answer: 0, exp: "Đúng nghĩa: Do you exercise every day? Yes, I do." },
        { text: "Does she eat a balanced diet? Yes, she does.", transcript: "Does she eat a balanced diet? Yes, she does.", options: ["Cô ấy có ăn chế độ cân bằng không? Có, cô ấy có.", "Anh ấy có tập gym không? Có, anh ấy có.", "Họ có uống nhiều nước không? Có, họ có."], answer: 0, exp: "Đúng nghĩa: Does she eat a balanced diet? Yes, she does." },
        { text: "Can I drink cold water after working out?", transcript: "Can I drink cold water after working out?", options: ["Tôi có thể uống nước lạnh sau khi tập luyện không?", "Tôi có thể đi bơi vào buổi sáng không?", "Tôi có thể ăn đồ ngọt vào buổi tối không?"], answer: 0, exp: "Đúng nghĩa: Can I drink cold water after working out?" },
        { text: "Could we improve our muscle strength?", transcript: "Could we improve our muscle strength?", options: ["Chúng ta có thể cải thiện sức mạnh cơ bắp không?", "Chúng ta có thể giảm cân nhanh chóng không?", "Chúng ta có thể ngủ nhiều hơn không?"], answer: 0, exp: "Đúng nghĩa: Could we improve our muscle strength?" },
        { text: "Were they suffering from severe stress?", transcript: "Were they suffering from severe stress?", options: ["Họ có bị căng thẳng nặng không?", "Họ có đang tập thể dục không?", "Họ có đi khám bác sĩ không?"], answer: 0, exp: "Đúng nghĩa: Were they suffering from severe stress?" },
        { text: "Has he started the medical treatment yet?", transcript: "Has he started the medical treatment yet?", options: ["Anh ấy đã bắt đầu điều trị y tế chưa?", "Cô ấy đã khỏi bệnh chưa?", "Bác sĩ đã khám xong chưa?"], answer: 0, exp: "Đúng nghĩa: Has he started the medical treatment yet?" },
        { text: "Have you started working out again?", transcript: "Have you started working out again?", options: ["Bạn đã bắt đầu tập luyện trở lại chưa?", "Bạn đã nghỉ học từ bao giờ thế?", "Bạn đã ăn tối chưa?"], answer: 0, exp: "Đúng nghĩa: Have you started working out again?" },
        { text: "Was it your grandfather who taught you?", transcript: "Was it your grandfather who taught you?", options: ["Có phải ông của bạn là người đã dạy bạn không?", "Có phải bác sĩ là người đã khám cho bạn không?", "Có phải bố bạn là người đã nấu ăn không?"], answer: 0, exp: "Đúng nghĩa: Was it your grandfather who taught you?" },
        { text: "Yes, I have.", transcript: "Yes, I have.", options: ["Vâng, đúng vậy (Hiện tại hoàn thành).", "Không, tôi chưa từng.", "Vâng, tôi đã làm hôm qua."], answer: 0, exp: "Đúng nghĩa: Yes, I have." },
        { text: "Yes, it was.", transcript: "Yes, it was.", options: ["Vâng, đúng vậy (Quá khứ đơn).", "Không, không phải.", "Vâng, tôi có thể."], answer: 0, exp: "Đúng nghĩa: Yes, it was." }
    ],

    // 5. Ngữ pháp: Quá khứ đơn vs Hiện tại hoàn thành (Past simple vs Present perfect)
    ...
    grammarQuiz: [
        ...
        { q: "2. She (suffer) _________ from a serious headache, but after treatment, she felt better.", options: ["suffered", "has suffered", "suffers", "is suffering"], answer: 0, exp: "Hành động xảy ra và kết thúc trong quá khứ dùng Quá khứ đơn (suffered)." },
        { q: "3. Our living conditions (improve) __________________ over the last few decades.", options: ["improved", "have improved", "improve", "were improving"], answer: 1, exp: "Có 'over the last few decades' (trong những thập kỷ qua) dùng Hiện tại hoàn thành (have improved)." },
        { q: "4. The doctor (just, examine) _________________ her. Fortunately, she is fine now.", options: ["has just examined", "examined", "just examined", "was examining"], answer: 0, exp: "Có 'just' diễn tả hành động vừa mới xảy ra dùng Hiện tại hoàn thành (has just examined)." },
        { q: "5. I _________ (live) in this city since 2010.", options: ["lived", "have lived", "live", "am living"], answer: 1, exp: "Có 'since' dùng Hiện tại hoàn thành (have lived)." },
        { q: "6. They _________ (move) to a new house last month.", options: ["moved", "have moved", "move", "moving"], answer: 0, exp: "Có 'last month' dùng Quá khứ đơn (moved)." },
        ...
        { q: "8. We _________ (visit) our grandparents last weekend.", options: ["visited", "have visited", "visit", "were visiting"], answer: 0, exp: "Có 'last weekend' dùng Quá khứ đơn (visited)." },
        ...
        { q: "10. Einstein _________ (be) a great scientist in the 20th century.", options: ["was", "has been", "is", "were"], answer: 0, exp: "Mốc thời gian trong quá khứ đã qua dùng Quá khứ đơn (was)." }
    ],

    // 6. Bài đọc hiểu (Reading Passage & Questions)
    ...
    readingTF: [
        { q: "1. Staying healthy only requires proper medical care according to the text.", options: ["True", "False"], answer: 1, exp: "False: Cần sự kết hợp của nhiều yếu tố (thói quen, chăm sóc y tế, tinh thần)." },
        { q: "2. Many people have changed their lifestyles to improve their health recently.", options: ["True", "False"], answer: 0, exp: "True: Được nêu rõ trong bài (Over the past few years...)." },
        { q: "3. Working out at gyms helps build muscle strength and flexibility.", options: ["True", "False"], answer: 0, exp: "True: Giúp xây dựng sức mạnh cơ bắp và độ dẻo dai." },
        { q: "4. Doctors examine patients only after serious illnesses develop.", options: ["True", "False"], answer: 1, exp: "False: Khám định kỳ để phòng ngừa trước khi bệnh phát triển." },
        { q: "5. Balanced diet and good sleep help prevent chronic stress and fatigue.", options: ["True", "False"], answer: 0, exp: "True: Giúp tránh bị căng thẳng kéo dài và mệt mỏi." }
    ],
    readingFill: [
    ...
    readingMC: [
        ...
        { q: "5. What is the main idea of the passage?", options: ["Methods to stay healthy and live longer", "How to cure a headache", "Benefits of fast food", "History of gym sports"], answer: 0, exp: "Các phương pháp để duy trì sức khỏe và sống lâu hơn." }
    ],

    // 7. Hướng dẫn viết đoạn văn (Writing Guide)
    writingGuides: [
